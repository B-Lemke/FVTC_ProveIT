BEGIN
	...
	(@UserId3, 'blemke4@gmail.com', CONVERT(VARCHAR(40), HashBytes('SHA1', Concat('pa$$word',@UserId3)), 2), 'Broderick', 'Lemke', 'Assets/Images/B-Lemke/Profiles/ProfileImage/squareImage.png', @UserTypeIdUser, 'B-Lemke'),
